...
Route::get('/articles', function () {
    ...
    return response()->json(new \App\Laravue\JsonResponse(['items' => $data, 'total' => mt_rand(1000, 10000)]));
});
...
Route::get('articles/{id}', function($id) {
    ...
    return response()->json(new \App\Laravue\JsonResponse($article));
});
...
Route::get('articles/{id}/pageviews', function($id) {
    ...
    return response()->json(new \App\Laravue\JsonResponse(['pvData' => $data]));
});
